...
def number_of_exchange_options():
    # Зададим номиналы купюр
    denominations = [500, 200, 100, 50]
    amount = 1000

    # Инициализируем массив dp для хранения количества вариантов размена
    dp = [0] * (amount + 1)
    dp[0] = 1  # Нулевая сумма можно разменять одним способом

    # Динамическое программирование: заполняем массив dp
...
# Вызов функции и вывод комбинаций
limit = 10
